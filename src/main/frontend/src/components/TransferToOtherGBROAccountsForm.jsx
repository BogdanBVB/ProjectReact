...
function TransfersToOtherGBROAccounts() {
    ...
    const handleTransfer = (e) => {
        ...
        axios.post('/api/otherGBROAccounts/executeTransferToGBROAccounts', payload)
            .then(() => {
                alert('Transfer successful');
                navigate('/otherGBROAccounts'); // Redirect on success
            })
            .catch(error => {
    ...
    return (
        <div className="dashboard2-container">
            <h1 className="accounts-title">Transfer to Other GBRO Accounts</h1>
            ...
            <form onSubmit={handleTransfer} className="form-container">
                <div className="form-group">
                    ...
                    <select
                        id="fromAccount"
                        className="form-input" // Updated for consistent styling
